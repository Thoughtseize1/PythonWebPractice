...
def grab_autrhor_biography(session, page_url):
    ...
    return birthday_date, born_location, description
...
def collect_authors_on_page(session, page_url):
    ...
    for div in div_class_quote:
        ...
        qoutes = {}
        qoutes["tags"] = [tag.text for tag in div.find_all("a", class_="tag")]
        qoutes["author"] = name_of_author
        qoutes["quote"] = div.span.text
